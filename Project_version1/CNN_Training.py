...
This is a blog about feeding your data into the CNN model.

Understanding Keras: https://keras.io/
https://www.youtube.com/watch?v=QaCSzIzd3Vs&list=PLd9i_xMMzZF7eIjnVuPxggYuGPg5CnA1l


Extra comments: Change the path names -- path1 and path2 accordingly.
'''
...
def main():
    ...
    #Call Resize only the very first time---when the database is loaded
